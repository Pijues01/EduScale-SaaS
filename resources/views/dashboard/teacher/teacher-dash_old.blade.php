        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Class shedule:</h6>
                    <a class="collapse-item" href="{{ route('teacher.schedule') }}">Class shedule</a>
                    ...
                    <a class="collapse-item" href="{{ route('teacher.holidays.index') }}">Holidays</a>
                    <a class="collapse-item" href="{{ route('teacher.feedback') }}">Feedback or Objection</a>
                </div>
            </div>
        </li>
        <li class="nav-item">
...
@section('content')
    <div class="container-fluid">
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">Dashboard of Teacher</h1>
    </div>
@endsection
